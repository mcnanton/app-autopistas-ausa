...
transito_2018<-read.csv("flujo-vehicular-2018.csv")
...
#Calculo tránsito por día y por hora en cada autopista. Esto aportará a futuras versiones de la app
...
intervenciones_2018<-read.csv("intervenciones-de-seguridad-vial.csv")
